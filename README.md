...
Assemble as given, and upload [`transmitter.ino`](dronetx.ino) to the Arduino NANO on the transmitter, and [`receiver.ino`](receiver.ino) to the Arduino NANO on the receiver.
